function go()
{
	...
	document.theform.thelink1.value = "http://anonym.zone66.su/?" + x + "" + y;
	document.theform.thelink2.value = "<a href=\"http://anonym.zone66.su/?" + x + "" + y + "\">Anonymous to " + displayURL + "</a>";
	document.theform.thelink3.value = "[url=http://anonym.zone66.su/?" + x  + "" + y + "]Anonymous to " + displayURL + "[/url]";

	return false;
}
function generateCode(formName, displayIn)
{
	var script_path = "http://anonym.zone66.su/anonymize.js";
	...
	//the_code += "&lt;div&gt;anonyminized by anonym.zone66.su: &lt;span id=\"found_links\"&gt;&lt;/span&gt; links found; &lt;span id=\"anonyminized\"&gt;&lt;/span&gt; anonyminized&lt;/div&gt;\n\n";
